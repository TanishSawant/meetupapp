    ...
    return (
        <div>
            ...
            <div style={styles.head_banner}>
                ...
                <div style={styles.head_text}>
                    <Typography style={styles.text_head} align="left" variant="h1" component="h2">
                        <strong>Discover events for all the things you love</strong>
                    </Typography>
                </div>
            <img src={Logo_top} alt="Logo"/>
            {/* <h3 style={{color:"red", fontWeight: "bold"}}>WeMeet</h3> */}
            </div>
...
const styles = {
    ...
    text_head: {
        ...
        fontFamily: '"Graphik Meetup", -apple-system, BlinkMacSystemFont, Roboto, Helvetica, Arial, sans-serif'
    },
    head_text:{
        width:'500px',
        // BorderTop
